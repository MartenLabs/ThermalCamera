...
get_location = '/Users/mac/Dev/Project/ThermalCamera/Model/Custom/Datasets/Video/'
...
for file in file_list:
    ...
    try:
        os.mkdir(f"/Users/mac/Dev/Project/ThermalCamera/Model/Custom/Datasets/imgs/{file}")
    ...
    while True:
        ...
        if int(vidcap.get(1)) % 1 == 0:
            ...
            # 추출된 이미지가 저장되는 경로
            cv2.imwrite(f"/Users/mac/Dev/Project/ThermalCamera/Model/Custom/Datasets/imgs/{file}/{file}_{count}.png", image)
        count += 1
        img_count += 1
