...
#define AI_MODEL_MODEL_SIGNATURE     "313799ba5e872c04b58fec7204875576"
...
#define AI_TOOLS_DATE_TIME   "Mon Mar 18 17:11:41 2024"
...
/* Array#181 */
AI_ARRAY_OBJ_DECLARE(
  pool_117_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 64, AI_STATIC)
/* Array#182 */
AI_ARRAY_OBJ_DECLARE(
...
/* Array#183 */
AI_ARRAY_OBJ_DECLARE(
  nl_119_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 5, AI_STATIC)
/* Array#184 */
AI_ARRAY_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  ...
  53, 0x0,
  AI_SHAPE_INIT(4, 128, 7, 7, 1), AI_STRIDE_INIT(4, 4, 512, 512, 3584),
...
/* Tensor #181 */
AI_TENSOR_OBJ_DECLARE(
  pool_117_output, AI_STATIC,
  181, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 1, 1), AI_STRIDE_INIT(4, 4, 4, 256, 256),
  1, &pool_117_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  187, 0x0,
  AI_SHAPE_INIT(4, 1, 6, 6, 4), AI_STRIDE_INIT(4, 4, 4, 16, 96),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &pool_117_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_118_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  pool_117_chain, AI_STATIC_CONST, 4,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 579820, 1, 1),
    579820, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 49152, 1, 1),
    49152, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MODEL_IN_NUM, &serving_default_input_30_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MODEL_OUT_NUM, &nl_119_output),
